...
public class LoginUI extends JFrame {
    ...
    public LoginUI(UserManager userManager) {
        ...
        JButton forgotBtn = createStyledButton("Forgot Password?", new Color(18, 18, 18), new Color(31, 41, 55) );
        forgotBtn.setAlignmentX(Component.CENTER_ALIGNMENT);
        forgotBtn.setMaximumSize(new Dimension(150, 25));
        forgotBtn.setPreferredSize(new Dimension(150, 25));
        forgotBtn.setMinimumSize(new Dimension(150, 25));
        forgotBtn.setFont(new Font("SansSerif", Font.PLAIN, 12)); // optional, keeps text proportional


        forgotBtn.addActionListener(e -> {
            dispose();
            new ForgotPasswordUI(userManager);
        });
        ...
        loginBtn.addActionListener(e -> {
            ...
            if (user != null) {
                ...
                showStyledDialog(this, "Error, invalid credentials", "Invalid username or password", new Color(239, 68, 68));
            }
        });
